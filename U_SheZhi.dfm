object Form_SheZhi: TForm_SheZhi
  Left = 0
  Top = 0
  Caption = #39044#35272#35774#32622
  ClientHeight = 416
  ClientWidth = 737
  Color = clBtnFace
  ...
  object ColorListBox_wenzi: TColorListBox
    ...
    TabOrder = 0
    OnClick = ColorListBox_wenziClick
  end
  object ColorListBox_beijing: TColorListBox
    ...
    Style = [cbStandardColors, cbExtendedColors, cbPrettyNames]
    TabOrder = 1
    OnClick = ColorListBox_beijingClick
  end
  ...
  object Button_yanse_queding: TButton
    ...
    Caption = #30830#23450
    TabOrder = 3
    OnClick = Button_yanse_quedingClick
  end
  object Button_yanse_quxiao: TButton
    ...
    Caption = #21462#28040
    TabOrder = 4
    OnClick = Button_yanse_quxiaoClick
  end
